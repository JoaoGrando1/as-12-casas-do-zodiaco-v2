function MudaDesenho(){
    ...
    const valor = document.querySelector('#valor').value;
        ...
        if(data <= '05/21' && data >= '06/20'){
            ...
            imagem.setAttribute("width","300px");
            div.innerHTML = "Milo foi um dos únicos cavaleiros de ouro, junto com Saga, Aiolia e Mu, que não morreu em batalha contra outro cavaleiro, apenas sucumbindo contra os espectros quando chegou no castelo de Hades onde todos tinham metade de sua força por causa da barreira."
        }
        else if(data >= '02/19' && data <= '03/20'){
            texto2.innerHTML = "Peixes";
            imagem.setAttribute("src","img/peixes.jpg");
            imagem.setAttribute("width","300px");
            div.innerHTML = "É o mais belo de todas as 88 constelações e acredita fielmente que 'a força é a justiça'. Utiliza as características da rosa pelo Cosmo e aplica os golpes."
        }
            ...
            imagem.setAttribute("width","300px");
            div.innerHTML = Áries: "a constelação do Carneiro dos pelos de ouro, cujo significado é a Vida que se Sobressai à Morte. É dito que todo o Cavaleiro que traja a armadura dourada da constelação tem um destino considerando por muitos como triste e terrível.";
        }
        else{
